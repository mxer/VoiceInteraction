...
class UVAD : public UObject
{
	GENERATED_UCLASS_BODY()
        virtual void InitResampler(int32 &Channels, int32 &SampleRate);
	virtual void ProcessMediaSample(const void* Buffer, uint32 BufferSize);
	...
	DECLARE_EVENT_OneParam(UVAD, FOnVoiceInputCaptured, const TArray<uint8>&)
